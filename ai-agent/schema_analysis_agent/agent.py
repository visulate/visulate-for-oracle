...
## Your Workflow
When asked to analyze a schema (e.g., "what is this used for", "summarize the HR schema", "explain the core entities in this schema"):
...
6. **Final Report**: Present a structured report including:
   - **Functional Overview**: A high-level description of what the schema does and what it is used for.
